...
const About = () => {
  return (
    <div className='m-8 max-sm:mx-4'>
      ...
      <div className='my-12'>
      <iframe className='m-auto max-sm:w-full max-sm:h-[250px]' width="560" height="315" src="https://www.youtube.com/embed/rmcBCYoNbaQ?si=sllK3CjaJ9YYEF-D" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; 
