  ...
  <div className='flex flex-col max-sm:w-full'>
        <motion.div 
          ...
          // style={{
            ...
            // }}
          className='relative group overflow-hidden hover:shadow-lg duration-500 hover:shadow-iconbgHover'
          >
          ...
          <div className='sm:w-64 w-full sm:h-72 rounded-2xl overflow-hidden'>
            <img className='w-full sm:h-full object-cover group-hover:scale-125 duration-500' src={Img} alt="" />
          </div>
        </motion.div>
    </div>
  )
