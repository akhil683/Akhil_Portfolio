    ...
    <div className='flex flex-col max-sm:full'>
              <div className='relative'>
                <div className='absolute left-2 bottom-0 text-iconBg font-semibold'>
                  <span className='px-4 py-2 rounded-full bg-mainText hover:bg-violet hover:text-mainText duration-200'>{name}</span>
                  <p className='px-4 py-2 mt-4 rounded-full bg-mainText hover:bg-violet hover:text-mainText duration-200'>{position}</p>
                </div>
